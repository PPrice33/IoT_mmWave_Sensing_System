...
def parseCompressedSphericalPointCloudTLV(tlvData, tlvLength, pointCloud):
    ...
    # Convert from spherical to cartesian
    pointCloud[:,0:3] = sphericalToCartesianPointCloud(pointCloud[:, 0:3])
    #print(pointCloud[:,0:3])                                                        # PAUL CHANGE HERE (THIS IS WHAT NASIF WANTS)
    return numPoints, pointCloud
...
def parseTrackTLV(tlvData, tlvLength):
    ...
    targetsTup = {}                                                                    # PAUL EDIT
    targetsString = ''                                                                # PAUL EDIT
    for i in range(numDetectedTargets):
        ...
        targets[i,0] = targetData[0] # Target ID								# PAUL EDIT
        ...
        # targetsTup[i,'ID'] = targetData[0] # Target ID
        # targetsTup[i,'XPos'] = targetData[1] # X Position
        # targetsTup[i,'YPos'] = targetData[2] # Y Position
        # targetsTup[i,'ZPos'] = targetData[3] # Z Position
        # targetsTup[i,'XVel'] = targetData[4] # X Velocity
        # targetsTup[i,'YVel'] = targetData[5] # Y Velocity
        # targetsTup[i,'ZVel'] = targetData[6] # Z Velocity
        # targetsTup[i,'XAcc'] = targetData[7] # X Acceleration
        # targetsTup[i,'YAcc'] = targetData[8] # Y Acceleration
        # targetsTup[i,'ZAcc'] = targetData[9] # Z Acceleration
        # targetsTup[i,'G'] = targetData[26] # G
        # targetsTup[i,'Conf'] = targetData[27] # Confidence Level

        # targetsString = str(targetData[0]) + "," # Target ID                                         # PAUL ADDED 
        # targetsString += str(targetData[1]) + "," # X Position
        # targetsString += str(targetData[2]) + "," # Y Position
        # targetsString += str(targetData[3]) + "," # Z Position
        # targetsString += str(targetData[4]) + "," # X Velocity
        # targetsString += str(targetData[5]) + "," # Y Velocity
        # targetsString += str(targetData[6]) + "," # Z Velocity
        # targetsString += str(targetData[7]) + "," # X Acceleration
        # targetsString += str(targetData[8]) + "," # Y Acceleration
        # targetsString += str(targetData[9]) + "," # Z Acceleration
        # targetsString += str(targetData[26]) + "," # G
        # targetsString += str(targetData[27]) # Confidence Level

        #print(targets[i,0], targets[i,1], targets[i,2], targets[i,3]+1.5)                           # PAUL EDITED THESE TO PRINT TID SUBINFO
        
        # Throw away EC
        tlvData = tlvData[targetSize:]
    return numDetectedTargets, targets                                                              # PAUL CHANGED targets to targetsString
...
def parseTrackHeightTLV(tlvData, tlvLength):
    ...
    for i in range(numDetectedHeights):
        ...
        #print(targetData[1],targetData[2])                                                      # PAUL EDIT
