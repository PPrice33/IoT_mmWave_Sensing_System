...
def parseStandardFrame(frameData):
    ...
    for i in range(numTLVs):
        ...
        # Target 3D
            ...
            numDetectedTracks, trackData = parseTrackTLV(frameData[:tlvLength], tlvLength)                                                                              # PAUL EDITED THIS
    ...
    return outputDict
    #return trackData    #PAUL EDITED THIS TO LIMIT TO trackData
